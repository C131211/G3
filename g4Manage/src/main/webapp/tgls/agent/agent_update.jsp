    ...
    <form id="updateAgent" class="layui-form" enctype="multipart/form-data">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline shortInput">
                <input type="text" name="uAccount" value="${result.data.uAccount}"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline shortInput">
                <input type="text" name="uName" value="${result.data.uName}"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline shortInput">
                <input type="text" name="uName" value="${result.data.uPwd}"
                       autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline shortInput">
                <input type="text" name="uTel" value="${result.data.uTel}"
                       autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline shortInput">
                <input type="text" name="uAddr" value="${result.data.uAddr}"
                       autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline shortInput">
                <input type="text" name="rID"
                       value="${result.data.rID}"
                       autocomplete="off" class="layui-input">
            </div>
            <span>tips:1超级管理员,2仓管员,3运输员</span>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">用户状态</label>
            <div class="layui-input-inline shortInput">
                <input type="text" name="uStatus"
                       value="${result.data.uStatus}"
                       autocomplete="off" class="layui-input">
            </div>
